...
public class PruebaEvaluacionArquitectura extends PApplet {
    ...
    public void setup() {
        ...
        rp2 = new RectangularPrism("Opcion2", color(255,255,0), new PVector(0,330,0), new PVector(60,60,20), new PVector(0,0,0), this);
        rp3 = new RectangularPrism("Opcion3", color(0,255,255), new PVector(0,410,0), new PVector(60,60,20), new PVector(0,0,0), this);
