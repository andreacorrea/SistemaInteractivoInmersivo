...
public class SpheresSkeletonVolume implements BuildingSkeletonVolumeStrategy {
    ...
    private void updateMembers(Body body) {
        ...
        updateLimbMember(body, "LEFT_FOREARM_S1", "LEFT_FOREARM_S2", "LEFT_FOREARM_S3", AdapterSimpleOpenNI.SKEL_LEFT_ELBOW, AdapterSimpleOpenNI.SKEL_LEFT_SHOULDER);
        updateLimbMember(body, "LEFT_ARM_S1", "LEFT_ARM_S2", "LEFT_ARM_S3", AdapterSimpleOpenNI.SKEL_LEFT_HAND, AdapterSimpleOpenNI.SKEL_LEFT_ELBOW);
        updateLimbMember(body, "RIGHT_FOREARM_S1", "RIGHT_FOREARM_S2", "RIGHT_FOREARM_S3", AdapterSimpleOpenNI.SKEL_RIGHT_ELBOW, AdapterSimpleOpenNI.SKEL_RIGHT_SHOULDER);
        updateLimbMember(body, "RIGHT_ARM_S1", "RIGHT_ARM_S2", "RIGHT_ARM_S3", AdapterSimpleOpenNI.SKEL_RIGHT_HAND, AdapterSimpleOpenNI.SKEL_RIGHT_ELBOW);
        updateLimbMember(body, "LEFT_THIGH_S1", "LEFT_THIGH_S2", "LEFT_THIGH_S3", AdapterSimpleOpenNI.SKEL_LEFT_KNEE, AdapterSimpleOpenNI.SKEL_LEFT_HIP);
        updateLimbMember(body, "LEFT_LEG_S1", "LEFT_LEG_S2", "LEFT_LEG_S3", AdapterSimpleOpenNI.SKEL_LEFT_FOOT, AdapterSimpleOpenNI.SKEL_LEFT_KNEE);
        updateLimbMember(body, "RIGHT_THIGH_S1", "RIGHT_THIGH_S2", "RIGHT_THIGH_S3", AdapterSimpleOpenNI.SKEL_RIGHT_KNEE, AdapterSimpleOpenNI.SKEL_RIGHT_HIP);
        updateLimbMember(body, "RIGHT_LEG_S1", "RIGHT_LEG_S2", "RIGHT_LEG_S3", AdapterSimpleOpenNI.SKEL_RIGHT_FOOT, AdapterSimpleOpenNI.SKEL_RIGHT_KNEE);
